...
CreatePlanResponse planResponseFromJson(String str) =>
    CreatePlanResponse.fromJson(json.decode(str));

String planResponseToJson(CreatePlanResponse data) =>
    json.encode(data.toJson());

class CreatePlanResponse extends BaseResponse {
  CreatePlanResponse({this.plans, message, baseStatus})
      : super(baseStatus: baseStatus, message: message);

  Plan? plans;

  CreatePlanResponse.fromJson(Map<String, dynamic> json) {
    plans = Plan.fromJson(json["plans"]);
