...
//
//     final ticketChatResponse = ticketChatResponseFromJson(jsonString);

import 'dart:convert';

import 'package:rosabon/model/response_models/base_response.dart';

TicketChatResponse ticketChatResponseFromJson(String str) =>
    TicketChatResponse.fromJson(json.decode(str));

String ticketChatResponseToJson(TicketChatResponse data) =>
    json.encode(data.toJson());

class TicketChatResponse extends BaseResponse {
  TicketChatResponse({this.reply, baseStatus, message})
...
class Reply {
  ...
  factory Reply.fromJson(Map<String, dynamic> json) => Reply(
        id: json["id"],
        ticket: ChatTicket.fromJson(json["ticket"]),
