...
class IdsDropDown extends StatelessWidget {
  final String? dropdownValue;
  final ValueChanged<Ids?> onChanged;
  final Color? dropIconColor;
  final Color? hintTextColor;
  final List<Ids>? items;
  @required
  ...
  Widget build(BuildContext context) {
    return DropdownButtonFormField2<Ids>(
