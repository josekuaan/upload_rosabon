...
class Plantransactions extends StatefulWidget {
  const Plantransactions({super.key});

  @override
  State<Plantransactions> createState() => _PlantransactionsState();
}

class _PlantransactionsState extends State<Plantransactions> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: const AppBarWidget(title: "Plan Transfer Deposit"),
      body: ListView(
                ...
                child: InkWell(
                  onTap: () {
                    screenshotController.capture().then((image) {
                      if (image != null) {
                        screenToPdf(
                            "transfer_${transaction.transactionId!}", image);
                      }
                    }).catchError((onError) {
                      print(onError);
                    });
