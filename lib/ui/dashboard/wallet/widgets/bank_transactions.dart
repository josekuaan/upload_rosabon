...
class Banktransactions extends StatefulWidget {
  const Banktransactions({super.key});
...
class _BanktransactionsState extends State<Banktransactions> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: const AppBarWidget(title: "Bank Transfer Deposit"),
      body: ListView(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        "₦${MoneyFormatter(amount: transaction.amount!.toDouble()).output.nonSymbol}",
                                        style: const TextStyle(
                                          fontFamily: "Montserrat",
                                          fontSize: 14,
                                          color: Colors.green,
